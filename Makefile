...
LDLIBS=-lconfig++ -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_video -lopencv_objdetect -lopencv_imgproc -lopencv_calib3d -lGL -lGLU -lglut -lSDL -lftgl -lboost_filesystem -lboost_system -lann -lpthread -lflycapture -lueye_api
DEBUG=-g -pg
