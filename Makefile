...
LDLIBS=-lconfig++ -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_video -lopencv_objdetect -lopencv_imgproc -lopencv_calib3d -lGL -lGLU -lSDL -lftgl -lboost_filesystem -lboost_system -lpthread -lflycapture
DEBUG=-g -pg
