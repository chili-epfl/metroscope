...
#ifndef CraftagLogger_HPP
#define CraftagLogger_HPP
...
class CraftagLogger: public Pipeable
{
    ...
    private:
        CraftagLogger();
        CraftagLogger(const CraftagLogger& pPipeableStub);
        CraftagLogger& operator=(const CraftagLogger& pPipeableStub);
};
