...
#ifndef MultipleMirror_HPP
#define MultipleMirror_HPP
...
class MultipleMirror : public FiducialDecorator
{
	public:
	...
	private:
		MultipleMirror();
		MultipleMirror(const MultipleMirror&);
		MultipleMirror& operator=(const MultipleMirror& );
