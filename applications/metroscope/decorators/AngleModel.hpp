...
#ifndef AngleModel_HPP
#define AngleModel_HPP

#include <qa/pipeables/misc/DecoratorManager.hpp>

namespace decorators {

class AngleModel : public FiducialDecorator
{
	public:
		static FiducialDecorator *create(libconfig::Setting &pSetting, DecoratorManager &pDecoratorManager);

		AngleModel(DecoratorManager &pDecoratorManager, FiducialMarker *pOrigin, FiducialMarker *pStart, FiducialMarker *pEnd, bool pClockwise);
		AngleModel(DecoratorManager &pDecoratorManager, FiducialMarker *pOrigin, FiducialMarker *pEnd, bool pClockwise);
