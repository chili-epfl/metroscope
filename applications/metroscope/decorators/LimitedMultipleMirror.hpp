...
#ifndef LimitedMultipleMirror_HPP
#define LimitedMultipleMirror_HPP
...
class LimitedMultipleMirror : public FiducialDecorator
{
	public:
		static decorators::FiducialDecorator *create(libconfig::Setting &pSetting, DecoratorManager &pDecoratorManager);
		LimitedMultipleMirror(DecoratorManager &pDecoratorManager, 
	...
	protected:
		...
		const FiducialMarker *mIdMarker;
	...
	private:
		LimitedMultipleMirror();
		LimitedMultipleMirror(const LimitedMultipleMirror&);
		LimitedMultipleMirror& operator=(const LimitedMultipleMirror& );
